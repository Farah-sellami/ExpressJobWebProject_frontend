                      ...
                      <div className="row">
                          <div className="col-md-4">
                            ...
                            <Link to="/" className="navbar-brand  d-flex align-items-center">
                                  ...
                                  <svg className="icon-30 text-primary" width="30" viewBox="0 0 30 30" fill="none"
                                  ...
                                  <h4 className="logo-title ms-3 text-white">EXPRESS JOB</h4>
                                  </Link>
                              <p className="mb-4 mt-4">Trouver votre besoin avec un simple clique !
                               </p>
                              <div className="d-flex align-items-center pt-2 mb-3">
                                  ...
                                  <p className="ms-4 mb-0 text-white">Sfax Medina-Tunisie 3001</p>
                              </div>
                              <div className="d-flex align-items-center">
                                  ...
                                  <p className="ms-4 mb-0 text-white">+216 55 011 122</p>
                              </div>
                          </div>
                          <div className="col-md-2 mt-md-0 mt-4">
                              <h5 className="mb-4 text-white">Liens</h5>
                              <ul className="m-0 p-0 list-unstyled text-white">
                            

                                  <li className="mb-3">
                                      <svg className="me-2 text-primary" width="7" height="8" viewBox="0 0 7 8" fill="none">
                          ...
                          <div className="col-md-2 mt-md-0 mt-4">
                              <h5 className="mb-4 text-white">Aide</h5>
                              <ul className="m-0 p-0 list-unstyled text-white">
                                  <li className="mb-3">
                                      <svg className="me-2 text-primary" width="7" height="8" viewBox="0 0 7 8" fill="none">
                                          <circle cx="3.5" cy="4" r="3.5" fill="currentColor" />
                                  ...
                                  <li className="mb-3">
                                      <svg className="me-2 text-primary" width="7" height="8" viewBox="0 0 7 8" fill="none">
                                          <circle cx="3.5" cy="4" r="3.5" fill="currentColor" />
                                      </svg>Politique de paiement
                                  </li>
                                 
                              </ul>
                          </div>
                          <div className="col-md-4 mt-md-0 mt-4">
                              <h5 className="mb-4 text-white">Rapport</h5>
                              <div className="input-group mb-4">
                                  <input type="text" className="form-control input-email ps-0"
                                      placeholder="firstname.lastname@mail.com" aria-label="email"
                                      aria-describedby="basic-addon1"/>
                                
                              </div>
                              <h5 className="pt-2 text-white">Social</h5>
                  ...
                  <div className="container py-4 footer-border">
                      <div className="row">
                          <div className="col-md-12 text-center text-white">
                              <p className="mb-0">©
                                  <script>document.write(new Date().getFullYear())</script> EXPRESS JOB, All Rights Reserved.
                              </p>
                          </div>
                      </div>
                  </div>
